import { rtrytryter, rtrytryterDetails, predefinedValues } from './types'

export const mockRtrytrytersList: rtrytryter[] = [
    {
        id: 1,
...
export const mockRtrytryterDetails: rtrytryterDetails = {
    id: 1,
    productionCenterId: '1',
    name: 'name',
    status: Math.random() < 0.5 ? 'Test' : 'Published',
...
export const mockRtrytryterPredefinedValues: predefinedValues = {
